...
def test_rumps_availability():
    ...
    try:
        ...
        print(
            f"   Version: {rumps.__version__ if hasattr(rumps, '__version__') else 'Unknown'}"
        )
        return True
    except ImportError:
...
def test_system_info():
    ...
    try:
        ...
        if "Apple" in processor:
            ...
            print(
                "❌ Intel processor detected - This application requires Apple Silicon"
            )
            return False
    except (subprocess.SubprocessError, OSError):
...
def main():
    ...
    for name, test_func in tests:
        ...
        except Exception as e:  # noqa: BLE001 - logged; test-runner guard
